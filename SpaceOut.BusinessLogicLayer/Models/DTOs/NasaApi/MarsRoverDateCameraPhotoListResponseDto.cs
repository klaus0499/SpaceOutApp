...
public class MarsRoverDateCameraPhotoListResponseDto : OperationResultResponse
{
    public List<MarsRoverDateCameraPhotoDto> Photos { get; set; } = new List<MarsRoverDateCameraPhotoDto>();
}

public class MarsRoverDateCameraPhotoDto
{
    public int Id { get; set; } = 0;
    public int Sold { get; set; } = 0;
    public MarsRoverCameraDataDto Camera { get; set; } = new();
    public string Img_Src { get; set; } = string.Empty;
    public string Earth_Date { get; set; } = string.Empty;
    public MarsRoverDataDto Rover { get; set; } = new();
}

public class MarsRoverCameraDataDto
{
    public int Id { get; set; } = 0;
